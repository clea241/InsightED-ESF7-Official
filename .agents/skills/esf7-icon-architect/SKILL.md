...
* **[Icon Catalog & Visual Guidelines](file:///e:/InsightED%20-%20ESF7%20Official/.agents/skills/esf7-icon-architect/references/icon_catalog_and_guidelines.md)**
...
```bash
node .agents/skills/esf7-icon-architect/scripts/audit_icons.js
```
