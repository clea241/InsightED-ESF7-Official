...
This project may also use `CLAUDE.md` (Claude Code), which mirrors
this file. `.agent/workflows/sync-specs.md` is available here as an
on-demand `/sync-specs` audit that checks `docs/ux/` against the
