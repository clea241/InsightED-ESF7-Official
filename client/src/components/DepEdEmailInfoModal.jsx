      ...
      >
        ...
        <div style={{ padding: '24px', fontSize: '13.5px', color: '#334155', lineHeight: '1.6' }}>
          ...
          <ul style={{ margin: '0 0 16px 0', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <li>
              DepEd emails are <strong>auto-generated by the system</strong> based on the personnel's registered name.
            </li>
            <li>
              If a teacher has an identical name to a personnel from another school, an email collision may occur.
            </li>
            <li>
              Verify that each teacher's email matches their official <code>@deped.gov.ph</code> address prior to final certification.
            </li>
          </ul>
