...
async function createOverloadLateTable() {
  ...
  try {
    console.log("Creating table 'overload_late'...");
    await client.query(`
    ...
    `);
    console.log("Table 'overload_late' created successfully!");
...
createOverloadLateTable().catch(err => {
